...
{ 
    ...
    {
        $queryWithInstansi = $this->select('kkn_jurnal_pelaksanaan.*, mahasiswa.*, kkn.*, kkn_lokasi.nama_lokasi as nama_lokasi, kkn_lokasi.alamat_lokasi as alamat_lokasi, prodi.nama_prodi as nama_prodi')
