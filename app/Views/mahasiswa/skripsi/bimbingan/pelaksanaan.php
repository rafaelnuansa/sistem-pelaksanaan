          ...
          <?php foreach ($data as $i => $row) : ?>
            <tr>
              ...
              <td class="text-center">
                ...
                <a href="<?= route_to('mahasiswa.kkn.jurnal.pelaksanaan.delete', $row['id_jurnal_pelaksanaan']); ?>" class="btn btn-primary btn-sm">Hapus</a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="<?= route_to('mahasiswa.kkn.jurnal.pelaksanaan.edit', $row['id_jurnal_pelaksanaan']); ?>">
        ...
        <table class="table table-hover" style="border: 1px solid #f0f0f0; margin-top: 10px;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Log Harian</td>
              <td>
                <a href="<?= route_to('mahasiswa.kkn.jurnal.pelaksanaan.cetak') ?>" target="_blank" class="btn btn-primary">Cetak</a>
              </td>
            </tr>
          </tbody>
        </table>
