  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      <?php else : ?>
        ...
        <div class="py-2">
          <button class="btn btn-primary daftar" style="margin-bottom:20px;">Daftar Sidang Skripsi</button>
        </div>
      <?php endif; ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Pendaftaran Sidang Skripsi</h4>
        </div>
        <div class="modal-body">
          <form action="<?= route_to('mahasiswa.skripsi.daftar') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row" style="margin-bottom: 10px;">
              ...
              <div class="col-md-5"><input type="file" class="form-control" name="sk_skripsi"></div>
            </div>
        </div>
