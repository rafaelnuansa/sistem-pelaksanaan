...
<head>
  ...
  div.centered h3 {
    margin-top: 5px; /* Adjust top margin for h3 elements */
    margin-bottom: 5px; /* Adjust bottom margin for h3 elements */
  }
    </style>
...
<table class="tg">
    <tbody>
        ...
        <tr>
            ...
            <td class="tg-0p91">10</td>
            <td class="tg-0p91"><?= $data->nilai_materi ;?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="tg-0p91">10</td>
            <td class="tg-0p91"><?= $data->nilai_pembahasan ;?></td>
        </tr>
        <tr>
            <td class="tg-iucd">Kesimpulan dan Saran</td>
            <td class="tg-0p91">10</td>
            <td class="tg-0p91"><?= $data->nilai_kesimpulan ;?></td>
        </tr>
        <tr>
...
"Times New Roman",serif'></span></p>
        ...
        <p class=Standard style='margin-left:304.8pt'><span style='font-family:"Times New Roman",serif'>Penilai, <?= $data->tempat_nama ?></span></p>
...
"Times New Roman",serif'>&nbsp;</span></p>
        ...
        <p class=Standard style='margin-left:304.8pt'><u><span lang=IN style='font-family:"Times New Roman",serif'><?= $data->dospeng ?></span></u></p>
