...
<div class="container-fluid">
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <!-- Form Filter -->
                <form action="<?= site_url('admin/berkas'); ?>" method="get">
                    ...
                    <a href="<?= base_url('admin/berkas'); ?>" class="btn btn-primary">Reset</a>
                </form>
                <hr>
                            ...
                            <?php foreach ($berkas as $key => $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= site_url('admin/berkas/delete/' . $item['id_berkas']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus berkas ini?');">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('admin/berkas'); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="editModalBody">
                <form action="<?= site_url('admin/berkas/update'); ?>" enctype="multipart/form-data" method="post">
