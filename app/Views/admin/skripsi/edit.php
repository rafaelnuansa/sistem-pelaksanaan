        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <?php if (session()->getFlashdata('error')) : ?>
                    ...
                    <?php endif; ?>
                    <form action="<?= route_to('admin.skripsi.update', $skripsi['id']); ?>" method="post">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="mahasiswa_id" class="form-control" required>
                                ...
                                <?php foreach ($mahasiswas as $mahasiswa) : ?>
                                    <option value="<?= $mahasiswa['id']; ?>" <?= $mahasiswa['id'] == $skripsi['mahasiswa_id'] ? 'selected' : ''; ?>><?= $mahasiswa['nim']; ?> | <?= $mahasiswa['nama']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
