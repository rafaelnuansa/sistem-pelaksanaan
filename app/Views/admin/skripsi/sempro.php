...
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Seminar Proposal</h3>
          ...
          <?php foreach ($pending_sempro as $i => $row) : ?>
            <tr>
              ...
              <td class="text-center">
                <button class="btn btn-success approve-sempro btn-sm" data-id="<?= $row['id'] ?>" data-mahasiswa-id="<?= $row['mahasiswa_id'] ?>" data-mahasiswa-nama="<?= $row['nama'] ?>" data-nama-pembimbing-1="<?= $row['nama_pembimbing_1'] ?>" data-nama-pembimbing-2="<?= $row['nama_pembimbing_2'] ?>"><i class="fa fa-check"></i></button>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
...
<!-- /.box -->
<div class="modal fade" id="modal-approve-sempro">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <select class="form-control" name="penguji_1_id" required>
                  ...
                  <?php foreach ($dosensSempro as $dosen) : ?>
...
<script>
  ...
  $('.approve-sempro').click(function() {
    ...
    $('#modal-approve-sempro [name="nama_pembimbing_1"]').val($(this).attr('data-nama-pembimbing-1'));
    $('#modal-approve-sempro [name="nama_pembimbing_2"]').val($(this).attr('data-nama-pembimbing-2'));
