...
class PKLJadwalController extends BaseController
{
    ...
    ->select('pkl_jadwal_sidang.*, mahasiswa.nim as nim, dosen_pembimbing.nama as dosen_pembimbing, mahasiswa.nama as nama_mahasiswa, dosen.nama as dospeng, dosen_penguji.nama as penguji, tempat_sidang.nama_tempat as tempat_nama')
