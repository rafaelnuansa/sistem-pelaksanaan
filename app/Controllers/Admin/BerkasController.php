...
class BerkasController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['berkas'] = $this->berkasModel->select('berkas.*, mahasiswa.nama AS nama_mahasiswa, prodi.nama_prodi AS nama_prodi')
        ->join('mahasiswa', 'mahasiswa.id = berkas.mahasiswa_id')
        ->join('prodi', 'prodi.id = mahasiswa.prodi_id')
        // ->where('berkas.mahasiswa_id', $this->mahasiswaId)
    ...
    //         return redirect()->to('/admin/berkas')->with('success', 'Berkas berhasil ditambahkan.');
    //     }
    //     return redirect()->to('/admin/berkas')->with('error', 'Gagal mengunggah berkas.');
    // }
    ...
    //     if (!$existingData) {
    //         return redirect()->to('/admin/berkas')->with('error', 'Data berkas tidak ditemukan.');
    //     }
    ...
    //         return redirect()->to('/admin/berkas')->with('success', 'Berkas berhasil diperbarui.');
    //     } catch (\Exception $e) {
    //         // Handle any exceptions that might occur during the update process
    //         return redirect()->to('/admin/berkas')->with('error', 'Gagal memperbarui berkas: ' . $e->getMessage());
    //     }
    // }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/admin/berkas')->with('success', 'Berkas berhasil dihapus.');
    }
}
